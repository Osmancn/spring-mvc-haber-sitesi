    ...
    <div id="container">
        <div >
            <div id="featured_post"><img src="${haberList[0].files[0].fileURL}" alt="" height="350" width="880">
                ...
                <p class="readmore"><a href="${contextPath}/haber/${haberList[0].ID}">Devamını Oku »</a></p>
            </div>
                    ...
                    <ul>
                        <c:forEach var = "j" begin = "1" end = "4">
                            ...
                            <li><img src="${haberList[(i*4)+j].files[0].fileURL}" alt="img bulunamadı" height="80" width="190">
                                ...
                                <p class="readmore"><a  href="${contextPath}/haber/${haberList[(i*4)+j].ID}">Devamını Oku »</a></p>
                            </li>
